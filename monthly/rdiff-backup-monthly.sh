...
# Settings
BACKUPDIR=/backup/rdiff/monthly
...
deletebackups()
{
log "== Delete OLD backups for host=$IP: rdiff-backup --remove-older-than ${REMOVEOLD} $1"
rdiff-backup --remove-older-than ${REMOVEOLD} $1 >> ${LOGFILE}
ERR=$?
